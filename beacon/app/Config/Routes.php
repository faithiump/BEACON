...
$routes->post('organization/createEvent', 'Organization::createEvent');
$routes->post('organization/createAnnouncement', 'Organization::createAnnouncement');
$routes->post('organization/createProduct', 'Organization::createProduct');
